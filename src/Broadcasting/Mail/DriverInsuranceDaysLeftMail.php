...
/**
 * Class DriverInsuranceDaysLeftMail
 * @package Src\Mail
 */
class DriverInsuranceDaysLeftMail extends Mailable
{
    use Queueable;
    ...
    {
        $this->body = new EmailSender(EmailTemplate::INSURANCE_DAYS_LEFT_DRIVER, ['days' => $days]);
    }
