...
/**
 * Class CreateDriverCandidate
 * @property mixed candidate
 * @property mixed info
 * @property mixed image
 * @package Src\Http\Requests
 */
class CreateDriverCandidateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'info.photo_file' => ['required', 'mimes:jpg,png,jpeg'],
            'info.passport_scan' => ['required', 'array'],
