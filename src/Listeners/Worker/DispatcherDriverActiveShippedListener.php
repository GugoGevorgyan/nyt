...
use Src\Broadcasting\Broadcast\Worker\DispatcherDriverActiveShipped;
...
/**
 * Class DispatcherDriverActiveShippedListener
 * @package Src\Listeners\Worker
 */
class DispatcherDriverActiveShippedListener
{
    /**
     * DispatcherDriverActiveShippedListener constructor.
     */
    ...
    public function handle(OrderShippedDriverEvent $event): void
    {
        ...
        foreach ($workers as $worker) {
            DispatcherDriverActiveShipped::broadcast($worker->system_worker_id, $worker->franchise_id, $passed_data);
        }
    }
