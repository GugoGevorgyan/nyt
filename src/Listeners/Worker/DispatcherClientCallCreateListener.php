...
use Src\Broadcasting\Broadcast\Worker\DispatcherCallCreated;
use Src\Core\Enums\ConstQueue;
use Src\Repositories\SystemWorker\SystemWorkerContract;

/**
 * Class DispatcherClientCallCreateListener
 * @package Src\Listeners\Worker
 */
class DispatcherClientCallCreateListener
{
    /**
     * DispatcherClientCallCreateListener constructor.
     */
    ...
    public function handle(object $event): void
    {
        ...
        foreach ($workers as $worker) {
            DispatcherCallCreated::broadcast($worker->system_worker_id, $worker->franchise_id, $clientCall);
        }
    }
