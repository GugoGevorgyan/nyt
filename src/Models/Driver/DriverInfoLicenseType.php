 ...
 */
class DriverInfoLicenseType extends ServiceModel
{
    /**
     * @var bool
     */
     ...
     * @var string
     */
    protected $table = 'driver_info_license_type';
    /**
     * @var string
     */
    protected $primaryKey = 'driver_info_license_type_id';
    /**
     * @var string[]
     */
     ...
     * @var string[]
     */
    protected $fillable = ['driver_info_id', 'license_type_id'];
}
