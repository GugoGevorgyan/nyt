...
namespace Artesaos\SEOTools\Facades {
     ...
     * @method static void addValue(string $key, array|string $value)
     ...
     * @method static void setSite(string $site)
     * @see \Artesaos\SEOTools\Contracts\JsonLd::addImage
     * @method static void addImage(array|string $image)
     * @see \Artesaos\SEOTools\Contracts\JsonLd::addValues
     * @method static void addValues(array $values)
     * @see \Artesaos\SEOTools\Contracts\JsonLd::setImages
     * @method static void setImages(array|string $images)
     * @see \Artesaos\SEOTools\Contracts\JsonLd::isEmpty
     * @method static void isEmpty()
     ...
     * @method static void setUrl(bool|null|string $url)
     */
    class JsonLd {}
     ...
     * @method static void setVideoEpisode(array $attributes = [])
     * @see \Artesaos\SEOTools\Contracts\OpenGraph::setMusicAlbum
     * @method static void setMusicAlbum(array $attributes = [])
     * @see \Artesaos\SEOTools\Contracts\OpenGraph::setType
     * @method static void setType(null|string $type = null)
     * @see \Artesaos\SEOTools\Contracts\OpenGraph::setMusicSong
     * @method static void setMusicSong(array $attributes = [])
     * @see \Artesaos\SEOTools\Contracts\OpenGraph::addAudio
     * @method static void addAudio(string $source = null, array $attributes = [])
     * @see \Artesaos\SEOTools\Contracts\OpenGraph::setArticle
     * @method static void setArticle(array $attributes = [])
     ...
     * @method static void setTitleDefault(string $default)
     * @see \Artesaos\SEOTools\Contracts\MetaTags::setPrev
     * @method static void setPrev(string $url)
     * @see \Artesaos\SEOTools\Contracts\MetaTags::setNext
     * @method static void setNext(string $url)
     * @see \Artesaos\SEOTools\Contracts\MetaTags::addAlternateLanguages
     * @method static void addAlternateLanguages(array $languages)
     * @see \Artesaos\SEOTools\Contracts\MetaTags::addAlternateLanguage
     * @method static void addAlternateLanguage(string $lang, string $url)
     * @see \Artesaos\SEOTools\Contracts\MetaTags::removeMeta
     * @method static void removeMeta(string $key)
     * @see \Artesaos\SEOTools\Contracts\MetaTags::addKeyword
     * @method static void addKeyword(array|string $keyword)
     ...
     * @method static void setKeywords(array|string $keywords)
     * @see \Artesaos\SEOTools\Contracts\MetaTags::setTitleSeparator
     * @method static void setTitleSeparator(string $separator)
     ...
     * @method static void addMeta(array|string $meta, string $value = null, string $name = 'name')
     * @see \Artesaos\SEOTools\Contracts\MetaTags::setTitle
     * @method static void setTitle(string $title, bool $appendDefault = true)
     ...
     * @method static void addImages(array|string $urls)
     ...
     * @method static void setImage(array|string $image)
...
namespace Kreait\Laravel\Firebase\Facades {
    ...
    /**
     * @see \Kreait\Firebase\Contract\Auth::changeUserPassword
     * @method static \Kreait\Firebase\Auth\UserRecord changeUserPassword(\Kreait\Firebase\Value\Uid|string $uid, \Kreait\Firebase\Value\ClearTextPassword|string $newPassword)
     * @see \Kreait\Firebase\Contract\Auth::signInWithRefreshToken
     * @method static \Kreait\Firebase\Auth\SignInResult signInWithRefreshToken(string $refreshToken)
     * @see \Kreait\Firebase\Contract\Auth::signInWithTwitterOauthCredential
     * @method static \Kreait\Firebase\Auth\SignInResult signInWithTwitterOauthCredential(string $accessToken, string $oauthTokenSecret, null|string $redirectUrl = null, null|string $linkingIdToken = null)
     * @see \Kreait\Firebase\Contract\Auth::deleteUser
     * @method static void deleteUser(\Kreait\Firebase\Value\Uid|string $uid)
     * @see \Kreait\Firebase\Contract\Auth::disableUser
     * @method static \Kreait\Firebase\Auth\UserRecord disableUser(\Kreait\Firebase\Value\Uid|string $uid)
     * @see \Kreait\Firebase\Contract\Auth::signInAnonymously
     * @method static \Kreait\Firebase\Auth\SignInResult signInAnonymously()
     * @see \Kreait\Firebase\Contract\Auth::createCustomToken
     * @method static \Lcobucci\JWT\Token createCustomToken(\Kreait\Firebase\Value\Uid|string $uid, array $claims = [])
     * @see \Kreait\Firebase\Contract\Auth::getEmailActionLink
     * @method static string getEmailActionLink(string $type, \Kreait\Firebase\Value\Email|string $email, \Kreait\Firebase\Auth\ActionCodeSettings|mixed[]|null $actionCodeSettings = null)
     * @see \Kreait\Firebase\Contract\Auth::getSignInWithEmailLink
     * @method static string getSignInWithEmailLink(\Kreait\Firebase\Value\Email|string $email, \Kreait\Firebase\Auth\ActionCodeSettings|mixed[]|null $actionCodeSettings = null)
     * @see \Kreait\Firebase\Contract\Auth::revokeRefreshTokens
     * @method static void revokeRefreshTokens(\Kreait\Firebase\Value\Uid|string $uid)
     * @see \Kreait\Firebase\Contract\Auth::parseToken
     * @method static \Lcobucci\JWT\Token parseToken(string $tokenString)
     * @see \Kreait\Firebase\Contract\Auth::listUsers
     * @method static \Traversable listUsers(int $maxResults = 1000, int $batchSize = 1000)
     * @see \Kreait\Firebase\Contract\Auth::signInWithGoogleIdToken
     * @method static \Kreait\Firebase\Auth\SignInResult signInWithGoogleIdToken(string $idToken, null|string $redirectUrl = null, null|string $linkingIdToken = null)
     * @see \Kreait\Firebase\Contract\Auth::signInWithAppleIdToken
     * @method static \Kreait\Firebase\Auth\SignInResult signInWithAppleIdToken(string $idToken, null|string $rawNonce = null, null|string $redirectUrl = null, null|string $linkingIdToken = null)
     * @see \Kreait\Firebase\Contract\Auth::signInWithCustomToken
     * @method static \Kreait\Firebase\Auth\SignInResult signInWithCustomToken(\Lcobucci\JWT\Token|string $token)
     * @see \Kreait\Firebase\Contract\Auth::createSessionCookie
     * @method static string createSessionCookie(\Lcobucci\JWT\Token|string $idToken, \DateInterval|int $ttl)
     * @see \Kreait\Firebase\Contract\Auth::getPasswordResetLink
     * @method static string getPasswordResetLink(\Kreait\Firebase\Value\Email|string $email, \Kreait\Firebase\Auth\ActionCodeSettings|mixed[]|null $actionCodeSettings = null)
     * @see \Kreait\Firebase\Contract\Auth::signInWithEmailAndOobCode
     * @method static \Kreait\Firebase\Auth\SignInResult signInWithEmailAndOobCode(\Kreait\Firebase\Value\Email|string $email, string $oobCode)
     * @see \Kreait\Firebase\Contract\Auth::signInWithEmailAndPassword
     * @method static \Kreait\Firebase\Auth\SignInResult signInWithEmailAndPassword(\Kreait\Firebase\Value\Email|string $email, \Kreait\Firebase\Value\ClearTextPassword|string $clearTextPassword)
     * @see \Kreait\Firebase\Contract\Auth::enableUser
     * @method static \Kreait\Firebase\Auth\UserRecord enableUser(\Kreait\Firebase\Value\Uid|string $uid)
     * @see \Kreait\Firebase\Contract\Auth::deleteUsers
     * @method static \Kreait\Firebase\Auth\DeleteUsersResult deleteUsers(iterable $uids, bool $forceDeleteEnabledUsers = false)
     * @see \Kreait\Firebase\Contract\Auth::signInWithFacebookAccessToken
     * @method static \Kreait\Firebase\Auth\SignInResult signInWithFacebookAccessToken(string $accessToken, null|string $redirectUrl = null, null|string $linkingIdToken = null)
     * @see \Kreait\Firebase\Contract\Auth::sendPasswordResetLink
     * @method static void sendPasswordResetLink(\Kreait\Firebase\Value\Email|string $email, \Kreait\Firebase\Auth\ActionCodeSettings|mixed[]|null $actionCodeSettings = null, null|string $locale = null)
     * @see \Kreait\Firebase\Contract\Auth::verifyIdToken
     * @method static \Lcobucci\JWT\Token verifyIdToken(\Lcobucci\JWT\Token|string $idToken, bool $checkIfRevoked = false)
     * @see \Kreait\Firebase\Contract\Auth::createUser
     * @method static \Kreait\Firebase\Auth\UserRecord createUser(\Kreait\Firebase\Request\CreateUser|mixed[] $properties)
     * @see \Kreait\Firebase\Contract\Auth::deleteCustomUserAttributes
     * @method static \Kreait\Firebase\Auth\UserRecord deleteCustomUserAttributes(\Kreait\Firebase\Value\Uid|string $uid)
     * @see \Kreait\Firebase\Contract\Auth::getEmailVerificationLink
     * @method static string getEmailVerificationLink(\Kreait\Firebase\Value\Email|string $email, \Kreait\Firebase\Auth\ActionCodeSettings|mixed[]|null $actionCodeSettings = null)
     * @see \Kreait\Firebase\Contract\Auth::confirmPasswordReset
     * @method static void confirmPasswordReset(string $oobCode, \Kreait\Firebase\Value\ClearTextPassword|string $newPassword, bool $invalidatePreviousSessions = true)
     * @see \Kreait\Firebase\Contract\Auth::sendEmailVerificationLink
     * @method static void sendEmailVerificationLink(\Kreait\Firebase\Value\Email|string $email, \Kreait\Firebase\Auth\ActionCodeSettings|mixed[]|null $actionCodeSettings = null, null|string $locale = null)
     * @see \Kreait\Firebase\Contract\Auth::getUserByEmail
     * @method static \Kreait\Firebase\Auth\UserRecord getUserByEmail(\Kreait\Firebase\Value\Email|string $email)
     * @see \Kreait\Firebase\Contract\Auth::unlinkProvider
     * @method static \Kreait\Firebase\Auth\UserRecord unlinkProvider(\Kreait\Firebase\Value\Uid|string $uid, \Kreait\Firebase\Value\Provider[]|string|string[] $provider)
     * @see \Kreait\Firebase\Contract\Auth::verifyPasswordResetCode
     * @method static void verifyPasswordResetCode(string $oobCode)
     * @see \Kreait\Firebase\Contract\Auth::getUserByPhoneNumber
     * @method static \Kreait\Firebase\Auth\UserRecord getUserByPhoneNumber(\Kreait\Firebase\Value\PhoneNumber|string $phoneNumber)
     * @see \Kreait\Firebase\Contract\Auth::sendSignInWithEmailLink
     * @method static void sendSignInWithEmailLink(\Kreait\Firebase\Value\Email|string $email, \Kreait\Firebase\Auth\ActionCodeSettings|mixed[]|null $actionCodeSettings = null, null|string $locale = null)
     * @see \Kreait\Firebase\Contract\Auth::signInWithIdpAccessToken
     * @method static \Kreait\Firebase\Auth\SignInResult signInWithIdpAccessToken(\Kreait\Firebase\Value\Provider|string $provider, string $accessToken, null|\Psr\Http\Message\UriInterface|string $redirectUrl = null, null|string $oauthTokenSecret = null, null|string $linkingIdToken = null, null|string $rawNonce = null)
     * @see \Kreait\Firebase\Contract\Auth::getUsers
     * @method static \Kreait\Firebase\Auth\UserRecord[]|null[] getUsers(array $uids)
     * @see \Kreait\Firebase\Contract\Auth::getUser
     * @method static \Kreait\Firebase\Auth\UserRecord getUser(\Kreait\Firebase\Value\Uid|string $uid)
     * @see \Kreait\Firebase\Contract\Auth::signInAsUser
     * @method static \Kreait\Firebase\Auth\SignInResult signInAsUser(\Kreait\Firebase\Auth\UserRecord|\Kreait\Firebase\Value\Uid|string $user, array|null $claims = null)
     * @see \Kreait\Firebase\Contract\Auth::createUserWithEmailAndPassword
     * @method static \Kreait\Firebase\Auth\UserRecord createUserWithEmailAndPassword(\Kreait\Firebase\Value\Email|string $email, \Kreait\Firebase\Value\ClearTextPassword|string $password)
     * @see \Kreait\Firebase\Contract\Auth::setCustomUserClaims
     * @method static void setCustomUserClaims(\Kreait\Firebase\Value\Uid|string $uid, array|null $claims)
     * @see \Kreait\Firebase\Contract\Auth::signInWithIdpIdToken
     * @method static \Kreait\Firebase\Auth\SignInResult signInWithIdpIdToken(\Kreait\Firebase\Value\Provider|string $provider, \Lcobucci\JWT\Token|string $idToken, null|\Psr\Http\Message\UriInterface|string $redirectUrl = null, null|string $linkingIdToken = null, null|string $rawNonce = null)
     * @see \Kreait\Firebase\Contract\Auth::setCustomUserAttributes
     * @method static \Kreait\Firebase\Auth\UserRecord setCustomUserAttributes(\Kreait\Firebase\Value\Uid|string $uid, array $attributes)
     * @see \Kreait\Firebase\Contract\Auth::changeUserEmail
     * @method static \Kreait\Firebase\Auth\UserRecord changeUserEmail(\Kreait\Firebase\Value\Uid|string $uid, \Kreait\Firebase\Value\Email|string $newEmail)
     * @see \Kreait\Firebase\Contract\Auth::sendEmailActionLink
     * @method static void sendEmailActionLink(string $type, \Kreait\Firebase\Value\Email|string $email, \Kreait\Firebase\Auth\ActionCodeSettings|mixed[]|null $actionCodeSettings = null, null|string $locale = null)
     * @see \Kreait\Firebase\Contract\Auth::confirmPasswordResetAndReturnEmail
     * @method static \Kreait\Firebase\Value\Email confirmPasswordResetAndReturnEmail(string $oobCode, \Kreait\Firebase\Value\ClearTextPassword|string $newPassword, bool $invalidatePreviousSessions = true)
     * @see \Kreait\Firebase\Contract\Auth::verifyPasswordResetCodeAndReturnEmail
     * @method static \Kreait\Firebase\Value\Email verifyPasswordResetCodeAndReturnEmail(string $oobCode)
     * @see \Kreait\Firebase\Contract\Auth::createAnonymousUser
     * @method static \Kreait\Firebase\Auth\UserRecord createAnonymousUser()
     * @see \Kreait\Firebase\Contract\Auth::updateUser
     * @method static \Kreait\Firebase\Auth\UserRecord updateUser(\Kreait\Firebase\Value\Uid|string $uid, \Kreait\Firebase\Request\UpdateUser|mixed[] $properties)
     */
    class FirebaseAuth {}

    /**
     * @see \Kreait\Firebase\Contract\Database::updateRules
     * @method static void updateRules(\Kreait\Firebase\Database\RuleSet $ruleSet)
     * @see \Kreait\Firebase\Contract\Database::getRuleSet
     * @method static \Kreait\Firebase\Database\RuleSet getRuleSet()
     * @see \Kreait\Firebase\Contract\Database::getReference
     * @method static \Kreait\Firebase\Database\Reference getReference(null|string $path = null)
     * @see \Kreait\Firebase\Contract\Database::runTransaction
     * @method static mixed runTransaction(callable $callable)
     * @see \Kreait\Firebase\Contract\Database::getReferenceFromUrl
     * @method static \Kreait\Firebase\Database\Reference getReferenceFromUrl(\Psr\Http\Message\UriInterface|string $uri)
     */
    class FirebaseDatabase {}

    /**
     * @see \Kreait\Firebase\Contract\DynamicLinks::getStatistics
     * @method static \Kreait\Firebase\DynamicLink\DynamicLinkStatistics getStatistics(\Kreait\Firebase\DynamicLink\GetStatisticsForDynamicLink|\Kreait\Firebase\Value\Url|mixed|\Psr\Http\Message\UriInterface|string $dynamicLinkOrAction, int|null $durationInDays = null)
     * @see \Kreait\Firebase\Contract\DynamicLinks::shortenLongDynamicLink
     * @method static \Kreait\Firebase\DynamicLink shortenLongDynamicLink(array|\Kreait\Firebase\DynamicLink\ShortenLongDynamicLink|\Kreait\Firebase\Value\Url|mixed|\Psr\Http\Message\UriInterface|string $longDynamicLinkOrAction, null|string $suffixType = null)
     * @see \Kreait\Firebase\Contract\DynamicLinks::createUnguessableLink
     * @method static \Kreait\Firebase\DynamicLink createUnguessableLink(array|\Kreait\Firebase\DynamicLink\CreateDynamicLink|\Kreait\Firebase\Value\Url|mixed|\Psr\Http\Message\UriInterface|string $url)
     * @see \Kreait\Firebase\Contract\DynamicLinks::createDynamicLink
     * @method static \Kreait\Firebase\DynamicLink createDynamicLink(array|\Kreait\Firebase\DynamicLink\CreateDynamicLink|\Kreait\Firebase\Value\Url|mixed|\Psr\Http\Message\UriInterface|string $actionOrParametersOrUrl, null|string $suffixType = null)
     * @see \Kreait\Firebase\Contract\DynamicLinks::createShortLink
     * @method static \Kreait\Firebase\DynamicLink createShortLink(array|\Kreait\Firebase\DynamicLink\CreateDynamicLink|\Kreait\Firebase\Value\Url|mixed|\Psr\Http\Message\UriInterface|string $url)
     */
    class FirebaseDynamicLinks {}

    /**
     * @see \Kreait\Firebase\Contract\Firestore::database
     * @method static \Google\Cloud\Firestore\FirestoreClient database()
     */
    class FirebaseFirestore {}

    /**
     * @see \Kreait\Firebase\Contract\Messaging::subscribeToTopics
     * @method static \string[][] subscribeToTopics(iterable $topics, \Kreait\Firebase\Messaging\RegistrationToken|\Kreait\Firebase\Messaging\RegistrationToken[]|\Kreait\Firebase\Messaging\RegistrationTokens|string|string[] $registrationTokenOrTokens)
     * @see \Kreait\Firebase\Contract\Messaging::unsubscribeFromTopic
     * @method static \string[][] unsubscribeFromTopic(\Kreait\Firebase\Messaging\Topic|string $topic, \Kreait\Firebase\Messaging\RegistrationToken|\Kreait\Firebase\Messaging\RegistrationToken[]|\Kreait\Firebase\Messaging\RegistrationTokens|string|string[] $registrationTokenOrTokens)
     * @see \Kreait\Firebase\Contract\Messaging::subscribeToTopic
     * @method static \string[][] subscribeToTopic(\Kreait\Firebase\Messaging\Topic|string $topic, \Kreait\Firebase\Messaging\RegistrationToken|\Kreait\Firebase\Messaging\RegistrationToken[]|\Kreait\Firebase\Messaging\RegistrationTokens|string|string[] $registrationTokenOrTokens)
     * @see \Kreait\Firebase\Contract\Messaging::validateRegistrationTokens
     * @method static \string[][] validateRegistrationTokens(\Kreait\Firebase\Messaging\RegistrationToken|\Kreait\Firebase\Messaging\RegistrationToken[]|\Kreait\Firebase\Messaging\RegistrationTokens|string|string[] $registrationTokenOrTokens)
     * @see \Kreait\Firebase\Contract\Messaging::unsubscribeFromTopics
     * @method static \string[][] unsubscribeFromTopics(array $topics, \Kreait\Firebase\Messaging\RegistrationToken|\Kreait\Firebase\Messaging\RegistrationToken[]|\Kreait\Firebase\Messaging\RegistrationTokens|string|string[] $registrationTokenOrTokens)
     * @see \Kreait\Firebase\Contract\Messaging::sendAll
     * @method static \Kreait\Firebase\Messaging\MulticastSendReport sendAll(\Kreait\Firebase\Messaging\Message[]|\Kreait\Firebase\Messaging\Messages $messages, bool $validateOnly = false)
     * @see \Kreait\Firebase\Contract\Messaging::unsubscribeFromAllTopics
     * @method static \string[][] unsubscribeFromAllTopics(\Kreait\Firebase\Messaging\RegistrationToken|\Kreait\Firebase\Messaging\RegistrationToken[]|\Kreait\Firebase\Messaging\RegistrationTokens|string|string[] $registrationTokenOrTokens)
     * @see \Kreait\Firebase\Contract\Messaging::getAppInstance
     * @method static \Kreait\Firebase\Messaging\AppInstance getAppInstance(\Kreait\Firebase\Messaging\RegistrationToken|string $registrationToken)
     * @see \Kreait\Firebase\Contract\Messaging::sendMulticast
     * @method static \Kreait\Firebase\Messaging\MulticastSendReport sendMulticast(\Kreait\Firebase\Messaging\Message|mixed[] $message, \Kreait\Firebase\Messaging\RegistrationToken|\Kreait\Firebase\Messaging\RegistrationToken[]|\Kreait\Firebase\Messaging\RegistrationTokens|string|string[] $registrationTokens, bool $validateOnly = false)
     * @see \Kreait\Firebase\Contract\Messaging::send
     * @method static mixed[] send(\Kreait\Firebase\Messaging\Message|mixed[] $message, bool $validateOnly = false)
     * @see \Kreait\Firebase\Contract\Messaging::validate
     * @method static mixed[] validate(\Kreait\Firebase\Messaging\Message|mixed[] $message)
     */
    class FirebaseMessaging {}

    /**
     * @see \Kreait\Firebase\Contract\RemoteConfig::rollbackToVersion
     * @method static \Kreait\Firebase\RemoteConfig\Template rollbackToVersion(int|\Kreait\Firebase\RemoteConfig\VersionNumber|string $versionNumber)
     * @see \Kreait\Firebase\Contract\RemoteConfig::listVersions
     * @method static \Kreait\Firebase\RemoteConfig\Version[]|\Traversable listVersions(\Kreait\Firebase\RemoteConfig\FindVersions|mixed[]|null $query = null)
     * @see \Kreait\Firebase\Contract\RemoteConfig::get
     * @method static \Kreait\Firebase\RemoteConfig\Template get()
     * @see \Kreait\Firebase\Contract\RemoteConfig::publish
     * @method static string publish(\Kreait\Firebase\RemoteConfig\Template|mixed[] $template)
     * @see \Kreait\Firebase\Contract\RemoteConfig::getVersion
     * @method static \Kreait\Firebase\RemoteConfig\Version getVersion(int|\Kreait\Firebase\RemoteConfig\VersionNumber|string $versionNumber)
     * @see \Kreait\Firebase\Contract\RemoteConfig::validate
     * @method static void validate(\Kreait\Firebase\RemoteConfig\Template|mixed[] $template)
     */
    class FirebaseRemoteConfig {}

    /**
     * @see \Kreait\Firebase\Contract\Storage::getStorageClient
     * @method static \Google\Cloud\Storage\StorageClient getStorageClient()
     * @see \Kreait\Firebase\Contract\Storage::getBucket
     * @method static \Google\Cloud\Storage\Bucket getBucket(null|string $name = null)
     */
...
namespace {
    ...
    class Currency extends Src\Support\Facades\Currency {}
    class DB extends Illuminate\Support\Facades\DB {}
    class Debugbar extends Barryvdh\Debugbar\Facade {}
    class Eloquent extends Illuminate\Database\Eloquent\Model {}
    class Event extends Illuminate\Support\Facades\Event {}
    class ExtYandex extends Src\Support\Facades\ExtYandex {}
    ...
    class FirebaseFirestore extends Kreait\Laravel\Firebase\Facades\FirebaseFirestore {}
    ...
    class Geo extends Src\Support\Facades\Geo {}
    class Handler extends Src\Support\Facades\HandlerFacade {}
    ...
    class Sms extends Src\Support\Facades\Sms {}
