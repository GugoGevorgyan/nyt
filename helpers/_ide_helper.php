 ...
 */
     ...
     */
        ...
        {            //Method inherited from \Illuminate\Foundation\Console\Kernel
                        /** @var \App\Kernels\Console $instance */
     ...
     */
        ...
        {
                        /** @var \App\Configures\Redis\RedisManager $instance */
                        $instance->createSubscription($channels, $callback, $method);
        }
                    /**
         ...
         */
        public static function connection($name = null)
        {            //Method inherited from \Illuminate\Redis\RedisManager
                        /** @var \App\Configures\Redis\RedisManager $instance */
                        return $instance->connection($name);
        }
                    /**
         ...
         * @param string $driver
         * @param \Closure $callback
         * @return \App\Configures\Redis\RedisManager
         * @static
         */
        public static function extend($driver, $callback)
        {            //Method inherited from \Illuminate\Redis\RedisManager
...
')
     ...
     */
         ...
         *
         *
         * @see \Src\Support\Collections\Gets::__invoke()
         * @param string $name
         * @static
         */
        public static function gets($name)
        {
                        return \Illuminate\Support\Collection::gets($name);
        }
                    /**
         *
         *
         * @see \App\Providers\SupportServiceProvider::collectsRegister()
         * @static
         */
        public static function recToRec()
        {
                        return \Illuminate\Support\Collection::recToRec();
        }
                    /**
         *
         *
         * @see \Src\Support\Collections\Item::__invoke()
         * @param string $name
         * @static
         */
        public static function item($name)
        {
                        return \Illuminate\Support\Collection::item($name);
        }
                    /**
         *
         *
         * @see \Src\Support\Collections\Paginate::__invoke()
         * @param int $perPage
         ...
         *
         *
         * @see \Src\Support\Collections\StringSerialize::__invoke()
         * @param string $name
         * @static
         */
        public static function stringSerialize($name)
        {
                        return \Illuminate\Support\Collection::stringSerialize($name);
        }
     ...
     */
        ...
        {
                        /** @var \Src\Exceptions\ExceptHelpers $instance */
     ...
     */
         ...
         * @static
         */
        public static function resizeImage($image_path, $width, $height, $filter_type = 1, $blur = 1, $best_fit = false, $crop_zoom = true)
        {
                        /** @var \Src\Core\Utils\ImageCommon $instance */
                        return $instance->resizeImage($image_path, $width, $height, $filter_type, $blur, $best_fit, $crop_zoom);
        }
    }
            /**
     * Class GeoFacade
     ...
     */
         ...
         * @static
         */
        public static function geocode($geocode, $result = 10, $format = 'json', $language = 'en_RU')
        {
                        /** @var \Src\Core\Geo\Geo $instance */
                        return $instance->geocode($geocode, $result, $format, $language);
        }
                    /**
         *
         *
         ...
         * @static
         */
        public static function matrix($origins, $destinations, $departure_time = null, $mode = 'driving')
        {
                        /** @var \Src\Core\Geo\Geo $instance */
                        return $instance->matrix($origins, $destinations, $departure_time, $mode);
        }
                    /**
         *
         *
         ...
         * @static
         */
        public static function route($from, $to, $departure_time = null, $avoid_tolls = 'false', $mode = 'driving')
        {
                        /** @var \Src\Core\Geo\Geo $instance */
                        return $instance->route($from, $to, $departure_time, $avoid_tolls, $mode);
        }
     ...
     */
        ...
        {
                        /** @var \Src\Core\Additional\QTSMS $instance */
                        $instance->send($phone, $text);
        }
     ...
     */
         ...
         * @static
         */
        public static function draftOrder()
        {
                        /** @var \Src\Core\Additional\YandexBusiness $instance */
                        return $instance->draftOrder();
        }
                    /**
         *
         *
         * @static
         */
        public static function draftChangeOrder()
        {
                        /** @var \Src\Core\Additional\YandexBusiness $instance */
                        return $instance->draftChangeOrder();
        }
                    /**
         *
         *
        ...
        {
                        /** @var \Src\Core\Additional\YandexBusiness $instance */
                        return $instance->processingOrder();
        }
                    /**
         *
         *
         ...
         * @static
         */
        public static function infoOrder()
        {
                        /** @var \Src\Core\Additional\YandexBusiness $instance */
                        return $instance->infoOrder();
        }
...
namespace  {
            ...
            class Image extends \Src\Support\Facades\Image {}
