...
class FirstTestCriterion implements BaseCriteriaContract
{
...
class SecondTestCriterion implements BaseCriteriaContract
{
    public function apply($builder, $repository)
    {
        return $builder->where('id', 2);
...
class ThirdTestWithArgumentsCriterion implements BaseCriteriaContract
{
    protected $from;
