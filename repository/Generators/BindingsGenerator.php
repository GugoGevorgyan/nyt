...
class BindingsGenerator extends Generator
{
    ...
    public function run(): int
    {
        ...
        File::put($this->getPath(),
            str_replace($this->bindPlaceholder, "\$this->app->bind({$repositoryInterface}, $repositoryEloquent);".PHP_EOL.'        '.$this->bindPlaceholder,
                $provider));
    }
    ...
    {
        $repositoryGenerator = new RepositoryInterfaceGenerator(['name' => $this->name]);
    ...
    {
        $repositoryGenerator = new RepositoryEloquentGenerator(['name' => $this->name,]);
