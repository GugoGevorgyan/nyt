...
export default class Service {
    ...
    find(params = {}, query = {}, args = true) {
        return axios.get(this.#route(params, args, Service.MODE_FIND), {
            params: query,
        });
    }
    ...
    store(resource, params = {}, query = {}, args = false) {
        return axios.post(this.#route(params, args, Service.MODE_CREATE), resource, {
            params: query,
        });
    }
    ...
    delete(params = {}, query = {}, args = true) {
        return axios.delete(this.#route(params, args, Service.MODE_DELETE), {
            params: query,
        });
    }
    ...
    remove(params = {}, query = {}, args = true) {
        return axios.delete(this.#route(params, args, Service.MODE_REMOVE), {
            params: query,
        });
    }
    ...
    restore(params = {}, query = {}, args = true) {
        return axios.put(this.#route(params, args, Service.MODE_RESTORE), null, {
            params: query,
        });
    }
    ...
    deletes(resource, params = {}, query = {}, args = false, passwordConfirm = "") {
        ...
        return axios.post(this.#route(params, args, Service.MODE_DELETES), resource, {
            params: query,
        });
    }
