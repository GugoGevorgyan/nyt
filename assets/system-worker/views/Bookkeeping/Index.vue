...
export default {
    ...
    data() {
        return {
            ...
            tabItems: [
                ...
                {
                    name: "Реестр заказов компаний по ценом",
                    key: 3,
    ...
    beforeCreate() {
        if ("/app/worker/bookkeeping" === this.$route.path || "/app/worker/bookkeeping/" === this.$route.path) {
            this.$router.push({ name: "bookkeeping_all_index" });
        }
    },
};
</script>
