...
export default class TariffsPagination extends Form {
    /** @type Boolean */
    loading = false;
    ...
    headers = [
        ...
        { text: "Тип", value: "tariff_type.name", sortable: false },
        { text: "Класс автомобиля", value: "cars.class_name", sortable: false },
        { text: "Минимальная цена", value: "minimal_price", sortable: false },
        { text: "Дата начала", value: "date_from", sortable: false },
        { text: "Дата окончания", value: "date_to", sortable: false },
